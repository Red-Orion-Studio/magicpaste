...
[![Descargar Windows](https://img.shields.io/badge/Windows-Descargar%20instalador-7C3AED?logo=windows&logoColor=white)](https://github.com/Red-Orion-Studio/magicpaste/releases/download/v0.1.0/MagicPaste-Setup-v0.1.0-beta.exe)
[![Descargar Android](https://img.shields.io/badge/Android-Descargar%20APK-7C3AED?logo=android&logoColor=white)](https://github.com/Red-Orion-Studio/magicpaste/releases/download/v0.1.0/app-release.apk)
...
> por favor [abre un issue](https://github.com/Red-Orion-Studio/magicpaste/issues). 🙏
